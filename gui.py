...
class ChatInterface(Frame):
    ...
    def __init__(self, master=None):
        ...
        help_option.add_command(label="About slackbot", command=self.msg)
    ...
    def msg(self):
        tkinter.messagebox.showinfo("slackbot",
                                    'slackbot is a chatbot for answering question regarding to nursery')

    def about(self):
        tkinter.messagebox.showinfo("slackbot Developers","sezal chauhan")
